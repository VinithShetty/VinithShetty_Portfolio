...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update(...args: any[]) {
        const { dt: dtVal, isBounce: bounce, BFECC: bfecc } = (args[0] || {}) as { dt?: number; isBounce?: boolean; BFECC?: boolean };
        if (!this.uniforms) return;
        if (typeof dtVal === 'number') this.uniforms.dt.value = dtVal;
        if (typeof bounce === 'boolean') this.line.visible = bounce;
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        const cursorSizeVal = props.cursor_size || 0;
    ...
    class Viscous extends ShaderPass {
      ...
      update(...args: any[]) {
        const { viscous: viscousVal, iterations, dt: dtVal } = (args[0] || {}) as { viscous?: number; iterations?: number; dt?: number };
        if (!this.uniforms) return;
    ...
    class Pressure extends ShaderPass {
      ...
      update(...args: any[]) {
        const { vel, pressure: pressureVal } = (args[0] || {}) as { vel?: any; pressure?: any };
