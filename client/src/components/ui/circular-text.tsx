...
const CircularText: React.FC<CircularTextProps> = ({
  ...
  return (
    <motion.div
      className={`absolute inset-0 flex items-center justify-center m-0 mx-auto rounded-full w-full h-full font-black text-white text-center cursor-pointer origin-center pointer-events-none ${className}`}
      initial={{ rotate: 0 }}
      animate={controls}
    ...
    >
      {letters.map((letter, i) => {
        ...
        const radius = 70; // radius in px for 64px button
